...
exports.followRequest = function(channel, username) {
    return `http://${addresses.HOSTNAME}:${addresses.CLIENTPORT}${exports.FOLLOW}?channel=${channel}&username=${username}`;
}
...
exports.subscriptionRequest = function(channel, username) {
    return `http://${addresses.HOSTNAME}:${addresses.CLIENTPORT}${exports.SUBSCRIPTION}?channel=${channel}&username=${username}`;
}
