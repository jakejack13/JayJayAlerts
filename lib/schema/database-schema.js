...
/**
 * database-schema.js
 * @file The schema used for data passed between the database and other nodes
 * @author Jacob Kerr
 */

const addresses = require('./address-schema');


/**
 * The fields stored in the database
 */
exports.FIELDS = ['channelname', 'isSub'];
...
exports.getRequest = function(channel, field) {
    return `http://${addresses.HOSTNAME}:${addresses.DATABASEPORT}${exports.GET}?channel=${channel}&field=${field}`;
}
 ...
 */
 exports.setRequest = function(channel, field, value) {
    return `http://${addresses.HOSTNAME}:${addresses.DATABASEPORT}${exports.SET}?channel=${channel}&field=${field}&value=${value}`;
}
 ...
 */
 exports.isRequest = function(field, value) {
    return `http://${addresses.HOSTNAME}:${addresses.DATABASEPORT}${exports.IS}?field=${field}&value=${value}`;
}
...
exports.addRequest = function(values) {
    ...
    let request = `http://${addresses.HOSTNAME}:${addresses.DATABASEPORT}${exports.ADD}?`;
...
exports.fieldRequest = function(field) {
    return `http://${addresses.HOSTNAME}:${addresses.DATABASEPORT}${exports.FIELD}?field=${field}`;
}
