...
exports.getRequest = function(channel, field) {
    return `${addresses.HOSTNAME}:${addresses.DATABASEPORT}${exports.GET}?channel=${channel}&field=${field}`
}
 ...
 */
 exports.setRequest = function(channel, field, value) {
    return `${addresses.HOSTNAME}:${addresses.DATABASEPORT}${exports.SET}?channel=${channel}&field=${field}&value=${value}`
}
 ...
 */
 exports.isRequest = function(field, value) {
    return `${addresses.HOSTNAME}:${addresses.DATABASEPORT}${exports.IS}?field=${field}&value=${value}`
}
...
exports.addRequest = function(values) {
    ...
    let request = `${addresses.HOSTNAME}:${addresses.DATABASEPORT}${exports.ADD}?`;
